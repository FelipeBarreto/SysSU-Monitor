...
public class RouteReply extends AODVMessage {
	...
	public RouteReply(Device destination, int destinationSequenceNumber, Device sourceAddress, int sourceSequenceNumber) {
		super();
		buildRREP(destination, destinationSequenceNumber,
	...
	private void buildRREP(Device destination, int destinationSequenceNumber, Device sourceAddress,
			int sourceSequenceNumber, Device nextHop, int hopCount, long lifetime) {
