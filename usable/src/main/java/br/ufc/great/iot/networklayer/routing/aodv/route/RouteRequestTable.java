...
public class RouteRequestTable {
	...
	public boolean removeRouteRequestEntry(Device sourceAddress, int broadcastId)
	{
	...
	private class RouteRequestKey {
		...
		public RouteRequestKey(Device sourceAddress, int brodcastId) {
			super();
		...
		public boolean equals(Object o) {
			...
			if(anotherKey.getBrodcastId() == broadcastId && 
					anotherKey.getSourceAddress().getUuid().compareTo(sourceAddress.getUuid())==0)
			{
				return true;
			}
			return false;
