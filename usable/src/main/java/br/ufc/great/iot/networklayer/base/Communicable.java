...
public abstract class Communicable {
         ...
         */
        protected void onDeviceConnect(Device device) {
            notifier.onDeviceConnect(device);
            updateNeighboorList(device);
        }

        /**
         * Notify when a connection has been lost
         */
        protected void onDeviceDisconnect(Device device) {
	...
	/*protected void onMessageSent(RoutingMessage message)
	{
         ...
         * @param address
         */
        protected void updateNeighboorList(Device device) {
            notifier.updateNeighboorList(device, this.getClass().getCanonicalName());
        }
