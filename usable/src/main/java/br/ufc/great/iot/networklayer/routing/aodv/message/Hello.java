...
public class Hello extends AODVMessage {
	...
	public Hello(int sourceSequenceNumber) {
		setNextHop(RemoteDevicesManager.getInstance().getCustomDevice(IRouter.BROADCAST));
		setDestinationAddress(RemoteDevicesManager.getInstance().getCustomDevice(IRouter.BROADCAST));
