...
{	
		void onDeviceFound(String uuid, String name, String address);
    	void onDeviceConnect(String uuid, String name, String address);
    	void onDeviceDisconnect(String uuid, String name, String address);
    	void onMessageReceived(String jsonMessage);
    	void onExceptionOcurred(int code, String message);

    	void onNotNeighborDeviceFound(String deviceUuid, String deviceName, String deviceAddress);
