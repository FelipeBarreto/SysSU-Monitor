package br.ufc.great.somc.networklayer.bluetooth;
...
import br.ufc.great.somc.networklayer.base.Communicable;
import br.ufc.great.somc.networklayer.base.CommunicableEventListener;
...
public class BluetoothCommunicable extends Communicable {
	...
	class SemcServiceConnection implements ServiceConnection {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
			Log.d("BluetoothCommunicable", "onServiceConnected");
	...
	public void onStart() {
		...
		Log.d("BluetoothCommunicable", "service bound with: " + context.bindService(intent, serviceConnection, Context.BIND_AUTO_CREATE));
	}
